...
export interface Scalars {
  ...
  type: "file"
    ...
    BSHBSelect__1128044141: 'published' | 'draft',
    Boolean: boolean,
...
export type BlockDocument = (Posts | PostsItem | Users | UsersItem | _AgentStart | _AgentUntitled | postsItem_AsList | usersItem_AsList) & { __isUnion?: true }
...
export type BlockList = (Posts | Users | postsItem_AsList | usersItem_AsList) & { __isUnion?: true }
...
export type UsersItemOrderByEnum = '_sys_createdAt__ASC' | '_sys_createdAt__DESC' | '_sys_hash__ASC' | '_sys_hash__DESC' | '_sys_id__ASC' | '_sys_id__DESC' | '_sys_lastModifiedAt__ASC' | '_sys_lastModifiedAt__DESC' | '_sys_slug__ASC' | '_sys_slug__DESC' | '_sys_title__ASC' | '_sys_title__DESC'
...
export interface _AgentUntitled {
    _agentKey: Scalars['String']
    _analyticsKey: Scalars['String']
    _dashboardUrl: Scalars['String']
    _id: Scalars['String']
...
export interface usersItem_AsList {
    _analyticsKey: Scalars['String']
    _dashboardUrl: Scalars['String']
    _id: Scalars['String']
    _idPath: Scalars['String']
...
export interface BlockDocumentGenqlSelection{
    ...
    on_UsersItem?: UsersItemGenqlSelection
    on__AgentStart?: _AgentStartGenqlSelection
    on__AgentUntitled?: _AgentUntitledGenqlSelection
    on_postsItem_AsList?: postsItem_AsListGenqlSelection
    on_usersItem_AsList?: usersItem_AsListGenqlSelection
    __typename?: boolean | number
...
export interface QueryGenqlSelection{
    ...
    /** Filter by a field. */
    filter?: (UsersItemFilterInput | null), 
    /** Limit the number of items returned. Defaults to 500. */
    first?: (Scalars['Int'] | null), 
    /** Order by a field. */
    orderBy?: (UsersItemOrderByEnum | null), 
    /** Search configuration */
    search?: (UsersItemSearchInput | null), 
    /** Skip the first n items. */
    skip?: (Scalars['Int'] | null)} })
    __typename?: boolean | number
    __fragmentOn?: "Query"
...
export interface UsersGenqlSelection{
    ...
    _title?: boolean | number
    /** Returns the first item in the list, or null if the list is empty. Useful when you expect only one result. */
    item?: UsersItemGenqlSelection
    /** Returns the list of items after filtering and paginating according to the arguments sent by the client. */
    items?: UsersItemGenqlSelection
    __typename?: boolean | number
    __fragmentOn?: "Users"
}

export interface UsersItemGenqlSelection{
    _analyticsKey?: { __args: {
    /**
     * The scope of the analytics key. Use `send` for just ingesting data. Use `query` if you need to show an analytics data in your website.
     * 
...
export interface _AgentUntitledGenqlSelection{
    _agentKey?: boolean | number
    _analyticsKey?: { __args: {
    /**
     * The scope of the analytics key. Use `send` for just ingesting data. Use `query` if you need to show an analytics data in your website.
...
export interface _agentsGenqlSelection{
    ...
    untitled?: _AgentUntitledGenqlSelection
    __typename?: boolean | number
...
export interface _componentsGenqlSelection{
    ...
    /** Skip the first n items. */
    skip?: (Scalars['Int'] | null)} })
    usersItem?: (usersItem_AsListGenqlSelection & { __args?: {
    /** Filter by a field. */
    filter?: (UsersItemFilterInput | null), 
    /** Limit the number of items returned. Defaults to 500. */
    first?: (Scalars['Int'] | null), 
...
export interface usersItem_AsListGenqlSelection{
    _analyticsKey?: { __args: {
    /**
     * The scope of the analytics key. Use `send` for just ingesting data. Use `query` if you need to show an analytics data in your website.
     * 
...
export interface FragmentsMap {
  ...
  Users: {
    root: Users,
    selection: UsersGenqlSelection,
}
  UsersItem: {
    root: UsersItem,
    selection: UsersItemGenqlSelection,
}
  Variant: {
    root: Variant,
  ...
  _AgentUntitled: {
    root: _AgentUntitled,
    selection: _AgentUntitledGenqlSelection,
}
  _BranchInfo: {
    root: _BranchInfo,
  ...
  usersItem_AsList: {
    root: usersItem_AsList,
    selection: usersItem_AsListGenqlSelection,
}
}
